...
<title>Clue Sheet: Game id - </title>
</head>
<body>
	...
	<form action="ClueGameServlet" method="post">
		...
		<table>
			<tr>
				<td><input type= "hidden" name="id" value="${requestAttribute.GameNum}"></td>
				<!--  check-boxes for suspects -->
				<td><input type="checkbox" name="scarlet" value="x"><span>Miss
						Scarlet</span></td>
				<td><input type="checkbox" name="mustard" value="x"><span>Col.
						Mustard</span></td>
				<td><input type="checkbox" name="white" value="x"><span>Mrs.
						White</span></td>
				<td><input type="checkbox" name="green" value="x"><span>Mr.
						Green</span></td>
				<td><input type="checkbox" name="peacock" value="x"><span>Ms.
						Peacock</span></td>
				<td><input type="checkbox" name="plum" value="x"><span>Prof.
						Plum</span></td>
			</tr>
		</table>
		<h1>Rooms</h1>
		<table>
			<tr>
				...
				<td><input type="checkbox" name="conservatory" value="x"><span>Conservatory</span></td>
				<td><input type="checkbox" name="billard" value="x"><span>Billiard
						Room</span></td>
				<td><input type="checkbox" name="dining" value="x"><span>Dining
						Room</span></td>
		...
		<table>
			<tr>
				...
				<td><input type="checkbox" name="candlestick" value="x"><span>Candlestick</span></td>
				<td><input type="checkbox" name="pipe" value="x"><span>Lead
						Pipe</span></td>
		...
		<br> <input type="submit" name="thisClicked" value="Submit">
